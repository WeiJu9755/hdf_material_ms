<?php
	 ...
	 */
	$aColumns = array( 'auto_seq','case_id','seq','floor','feed_type','feed_start_date','feed_end_date','return_item','return_start_date','return_end_date','makeby'
		,'last_modify','seq2','fees_item','est_feed_start_date','est_return_start_date','return_type');
	
	/* Indexed column (used for fast and accurate table cardinality) */
	$sIndexColumn = "auto_seq";
	
	/* DB table to use */
	$sTable = "overview_material_sub";
