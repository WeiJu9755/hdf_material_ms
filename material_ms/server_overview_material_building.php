<?php
	 ...
	 */
	$aColumns = array( 'a.building','a.scheduled_completion_date','a.builder_id','b.subcontractor_name','a.auto_seq','a.case_id','a.seq','a.eng_description');
	
	/* Indexed column (used for fast and accurate table cardinality) */
	$sIndexColumn = "auto_seq";
	
	/* DB table to use */
	$sTable = "overview_material_building";
